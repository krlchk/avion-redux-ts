  ...
  return (
    ...
    >
      ...
      <div className="mobile:p-4 absolute inset-x-0 bottom-0 translate-y-5 p-5 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
        <h3 className="mobile:text-lg mobile:leading-5 line-clamp-2 text-xl leading-6 font-bold text-[#f5f5f5]">
          {title}
        </h3>
        <p className="mobile:text-xs mt-2 text-sm font-medium text-[#f5f5f5]/75">
