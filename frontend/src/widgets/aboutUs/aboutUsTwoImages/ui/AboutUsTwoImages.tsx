...
export const AboutUsTwoImages = () => {
  return (
    <>
      <div className="tablet:min-h-130 mobile:min-h-90 min-h-180 bg-[url('/images/aboutUs/aboutUsOne.jpg')] bg-cover bg-center" />
      <Container className="tablet:gap-14 tablet:py-20 mobile:gap-10 mobile:py-14 flex flex-col gap-20 py-28 text-black">
        ...
        <div className="mobile:flex-col tablet:gap-12 flex w-full gap-20 text-base font-normal text-black/70">
          ...
          <p className="mobile:w-full w-1/2 leading-7">
            We work with designers and makers who care about proportion,
            texture and longevity. From statement chairs to quiet storage
            pieces, our collection is built around furniture that looks
            considered and feels easy to live with.
          </p>
        </div>
      </Container>
      <div className="tablet:min-h-130 mobile:min-h-90 min-h-180 bg-[url('/images/aboutUs/aboutUsTwo.jpg')] bg-cover bg-center" />
    </>
  );
};
