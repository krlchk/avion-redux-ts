...
export const HomeHeroProductCard = ({
  ...
  return (
    <div
      className="group relative min-h-52 cursor-pointer overflow-hidden border border-white/10 bg-cover bg-center shadow-[0_24px_60px_rgba(0,0,0,0.24)] transition-all duration-500 hover:-translate-y-2 hover:border-white/40 hover:shadow-[0_34px_90px_rgba(0,0,0,0.46)]"
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 translate-y-5 p-5 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
        <h3 className="line-clamp-2 text-xl leading-6 font-bold text-white">
          {title}
        </h3>
      ...
      <p className="absolute top-3 left-3 bg-white/95 px-3 py-1 text-xl font-bold text-[#947458] transition-colors duration-300 group-hover:bg-[#947458] group-hover:text-white">
        ${price}
      </p>
    </div>
  );
